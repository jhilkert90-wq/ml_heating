...
class PhysicsConstants:
    ...
    # Heat pump bounds (°C)
    MIN_OUTLET_TEMP = 22.0     # Minimum heat pump outlet temperature
    MAX_OUTLET_TEMP = 35.0     # Maximum safe heat pump outlet temperature
    ...
    MAXIMUM_SAFE_OUTLET_TEMP = 35.0       # °C - maximum safe heat pump outlet
    DEFAULT_FALLBACK_OUTLET = 28.0        # °C - fallback outlet temperature
    EQUILIBRIUM_OUTLET_MIN = 22.0         # °C - minimum equilibrium outlet temp
    EQUILIBRIUM_OUTLET_MAX = 33.0         # °C - maximum equilibrium outlet temp
